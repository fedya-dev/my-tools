...
$PASSWORD_HASH = '$2y$10$8.Xh.t5.Xh.Xh.Xh.Xh.Xh.Xh.Xh.Xh.Xh.Xh.Xh.Xh.Xh.Xh'; // Default: "admin" (This is a placeholder, strictly speaking verify logic below)
// Actually, let's use a simple direct comparison for this level of simplicity if user can't run shell to hash
// But for security, let's use a hash. The hash for "admin" is:
$PASSWORD_HASH = '$2y$10$tkFBHm81forKJoMGr89Yr.khYaNz9rsqZAyUYlZiR9odAcSxkMuT2'; 

// SIMPLIFIED AUTH (User can change this string)
...
$defaultTools = [
    ...
    // ... (rest of default tools kept same in logic, but re-saved if file missing)
];
